...
test("Ian Cowan icon wiggles on hover", () => {
  ...
  expect(
    screen
      .getByTestId("header-nav-li-ian-cowan")
      .classList.contains("wiggle-icon")
  ).toBeTruthy();
});
...
test("Projects icon wiggles on hover", () => {
  ...
  expect(
    screen
      .getByTestId("header-nav-li-projects")
      .classList.contains("wiggle-icon")
  ).toBeTruthy();
});
...
test("Contact icon wiggles on hover", () => {
  ...
  expect(
    screen
      .getByTestId("header-nav-li-contact")
      .classList.contains("wiggle-icon")
  ).toBeTruthy();
});
...
test("Expand button icon moves in the proper direction on hover", () => {
  ...
  expect(
    screen
      .getByTestId("header-nav-li-collapseButton")
      .classList.contains("arrow-move-right")
  ).toBeTruthy();
  expect(
    screen
      .getByTestId("header-nav-li-collapseButton")
      .classList.contains("arrow-move-left")
  ).toBeFalsy();
...
test("Clicking on the expand header hamburger raises the droped down nav", () => {
  ...
  expect(
    screen.getByTestId("header-nav-ul").classList.contains("expanded")
  ).toBeFalsy();
});
